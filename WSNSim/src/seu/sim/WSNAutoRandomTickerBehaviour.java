...
public class WSNAutoRandomTickerBehaviour extends TickerBehaviour{
  ...
  //  public Agent varAgent;
    ...
    */
    public WSNAutoRandomTickerBehaviour(WSNAgent a, long per)
    {
        super(a,per);
        agent=a;
        rand= new Random();
    ...
    public WSNAutoRandomTickerBehaviour(WSNAgent a)
    {
